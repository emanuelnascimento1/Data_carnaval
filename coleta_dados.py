...
def coletar_escolas():
    ...
    url = "https://pt.wikipedia.org/wiki/Resultados_do_Carnaval_do_Rio_de_Janeiro_em_2024"
...
def salvar_escolas(escolas_revisao):
    ...
    # Salvar ou adicionar escolas ao arquivo
    try:
        with open(nome_arquivo, 'a', encoding='utf-8') as f:
            escolas_revisao.to_csv(f, index=False, header=f.tell() == 0)
        print(f"As escolas foram adicionadas ao arquivo '{nome_arquivo}'.")
